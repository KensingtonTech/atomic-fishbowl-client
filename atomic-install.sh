...
chroot $HOST /usr/bin/docker create --name $NAME --network 221b-network -p 443:443 -v /etc/kentech:/etc/kentech:ro -v /var/kentech:/var/kentech:ro -v /var/log/nginx:/var/log/nginx:rw $IMAGE >/dev/null
