...
<modal id="{{id}}" (opened)="onOpen()">
  <div class="modal">
    <div class="modal-body splash-body" style="position: relative; width: 400px; background-color: rgba(0,0,0,.9); color: white; font-family: 'Gill Sans', 'Lucida Grande','Lucida Sans Unicode', Arial, Helvetica, sans-serif;">
      ...
      <div align="center"><h1>&lt;Insert<br>Logo<br>Here&gt;</h1></div>
      <!--<p align="center">
        <img src="resources/221B_logo.png" style="width: 350px; height: auto;">
        <img style="float: left; width: 75px; height: auto;" src="resources/logo-medium.png">
      </p>-->
      ...
      <div style="position: absolute; left: 5px; bottom: 15px;"><img style="width: 75px;" src="resources/logo-medium.png"></div>
    </div>
  </div>
</modal>
`,
