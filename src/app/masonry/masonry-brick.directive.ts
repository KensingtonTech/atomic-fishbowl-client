import { Directive, Inject, ElementRef, forwardRef, Input, OnDestroy, AfterViewInit, ChangeDetectorRef, NgZone } from '@angular/core';
...
export class MasonryBrickDirective implements OnDestroy, AfterViewInit {
  ...
  constructor(private el: ElementRef,
              ...
              @Inject(forwardRef(() => MasonryDirective)) private parent: MasonryDirective ) {}
  ...
  ngAfterViewInit(): void {
    ...
    // this.ngZone.runOutsideAngular( () => imagesLoaded(this.el.nativeElement, () => this.parent.add(this.el) ) );
